...
This will create a folder `2022-datascience-homework` on your computer, with the individual homeworks in subdirectories.

## Updating

As we release new homeworks, or if we discover mistakes and update an already released homework description,  you'll have to update your repository. You can do this by changing into the `2022-datascience-homework` directory and executing:
